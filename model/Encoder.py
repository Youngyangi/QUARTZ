...
class LSTM_encoder(tf.keras.layers.Layer):
    ...
    def call(self, item_embeddings, query_embeddings, **kwargs):
        ...
        query_sequence, query_hidden_state, query_memory_state = self.query_encoder(query, initial_state=init_state)
        return {'item_sequence': item_sequence, 'query_sequence': query_sequence, 'query_hidden': query_hidden_state}
